    ...
    **/
    ...
    public function connect($config='',$linkNum=0) {
        ...
        if ( !isset($this->linkID[$linkNum]) ) {
            ...
            $connew="(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=".$config['hostname'].")(PORT=".$config['hostport'].")))(CONNECT_DATA=(SID=".$config['database'].")))";
            $this->linkID[$linkNum] = $conn($config['username'], $config['password'],$connew,'UTF8');//modify by wyfeng at 2008.12.19
