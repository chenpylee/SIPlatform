...
<script type="text/javascript">
    var url_auditor_search="<?php echo U('Admin/Ajax/auditor_search_handler');?>";
</script>
<div class="row">
    <div class="col-xs-2 col-md-2">
        <ul class="nav nav-sidebar">
            <li class="active"><a href="#">稽核人员列表</a></li>
            <li><a href="#">添加稽核人员</a></li>
        </ul>
    </div>
    <div class="col-xs-2 col-md-10">
        <h3><span class="label label-success">稽核人员列表</span></h3>
        <div class="input-group custom-search-form">
            <input type="text" id="auditor-search-key" class="search-input form-control" placeholder="请输入要添加的稽核人员身份证号码或姓名">
                                <span class="input-group-btn">
                                <button id="auditor-search" class="btn btn-default" type="button">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading" id="search-title"></div>
...
<?php if(($current_controller_action) == "privilege/index"): ?><script type="text/javascript" language="javascript" src="/Public/js/jquery.dataTables.min.js"></script>
    <script type="text/javascript" language="javascript" src="/Public/js/dataTables.bootstrap.js"></script>
    <script type="text/javascript" language="javascript" src="/Public/js/admin/audit.list.js"></script><?php endif; ?>
